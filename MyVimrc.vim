...
"For lefside file open
"dlete if not working
Plug 'Shougo/defx.nvim'
Plug 'roxma/nvim-yarp'
Plug 'roxma/vim-hug-neovim-rpc'
"for searching files denite.nvim
...
"For cpp autocompliation funcation / delete if not working
...
inoremap <silent><expr> <TAB>
      ...
      \ coc#refresh()
"end cpp funcation delete if not working this
...
"Key binding for Telescope edit by amit
